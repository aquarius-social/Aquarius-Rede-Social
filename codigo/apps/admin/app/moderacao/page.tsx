...
type Motivo = 'desinformação' | 'assédio' | 'spam' | 'discurso de ódio';
type Sev = 'alta' | 'crítica' | 'baixa';
const DENUNCIAS: { tipo: string; motivo: Motivo; sev: Sev; flags: number; texto: string; autor: string; ctx: string; ia: number }[] = [
...
const MOTIVOS = [['Spam', 46], ['Desinformação', 25], ['Discurso de ódio', 16], ['Assédio', 13]] as const;
const ACAO = [
