...
// DEMONSTRAÇÃO — ilustra o fluxo gerado-vs-fonte. A fila real se enche quando o
// agente Prometeus for ligado (cada post é conferido contra a fonte antes de publicar).
const FILA = [
  {
