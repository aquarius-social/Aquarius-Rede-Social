...
-- Gerado de: 0001_identidade.sql, 0002_camadas_civicas.sql, 0003_votacao_nominal.sql, 0004_placar_nao_extraido.sql, 0005_vinculo_upsert.sql, 0006_camada_ouro.sql, 0007_ouro_coletivos.sql, 0008_despesas_ceap.sql, 0009_emendas.sql, 0010_senado.sql
-- =============================================================================
