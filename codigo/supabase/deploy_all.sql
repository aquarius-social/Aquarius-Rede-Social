...
-- =============================================================================
-- Concatenação, NA ORDEM, das migrations 0001–0006. Para o primeiro setup:
-- cole isto no SQL Editor do Supabase e rode uma vez.
-- Para MUDANÇAS depois, crie uma migration nova (nunca edite as antigas) e
-- use o fluxo de migrations do Supabase CLI. A fonte da verdade é migrations/.
-- Gerado a partir de: 0001_identidade.sql, 0002_camadas_civicas.sql, 0003_votacao_nominal.sql, 0004_placar_nao_extraido.sql, 0005_vinculo_upsert.sql, 0006_camada_ouro.sql
-- =============================================================================
